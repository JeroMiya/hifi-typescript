...
module audioReflectorTools {
    ...
    var reflectiveThumbX: number;
    var diffusionThumbX: number;
    var absorptionThumbX: number;

    function setReflectiveRatio(reflective: number) {
    ...
    function setDiffusionRatio(diffusion: number) {
    ...
    function setAbsorptionRatio(absorption: number) {
    ...
    function mouseMoveEvent(event: hifi.IMouseEvent) {
        ...
        if (movingSliderLocalFactor) {
            ...
            if (newThumbX < localFactorMinThumbX) {
                newThumbX = localFactorMinThumbX;
            }
    ...
    function mouseReleaseEvent(event: hifi.IMouseEvent) {
        if (movingSliderDelay) {
