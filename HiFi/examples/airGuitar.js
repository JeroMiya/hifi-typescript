    ...
    function checkHands(deltaTime) {
        for (var palm = 0; palm < 2; palm++) {
            ...
            if (palm == strumHand) {
                ...
                if ((((position.y < strumTriggerHeight) && (lastPosition.y >= strumTriggerHeight)) || ((position.y > strumTriggerHeight) && (lastPosition.y <= strumTriggerHeight))) && (trigger > 0.1)) {
...
//# sourceMappingURL=airGuitar.js.map
