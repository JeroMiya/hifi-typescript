...
//
var addVoxelOnMouseClickExample;
(function (addVoxelOnMouseClickExample) {
    function mousePressEvent(event) {
        ...
        if (intersection.intersects) {
            ...
            print("clicked on voxel.red/green/blue=" + intersection.voxel.red + ", " + intersection.voxel.green + ", " + intersection.voxel.blue);
            print("clicked on voxel.x/y/z/s=" + intersection.voxel.x + ", " + intersection.voxel.y + ", " + intersection.voxel.z + ": " + intersection.voxel.s);
            ...
            print("Voxels.setVoxel(" + newVoxel.x + ", " + newVoxel.y + ", " + newVoxel.z + ", " + newVoxel.s + ", " + newVoxel.red + ", " + newVoxel.green + ", " + newVoxel.blue + ")");
...
})(addVoxelOnMouseClickExample || (addVoxelOnMouseClickExample = {}));
//# sourceMappingURL=addVoxelOnMouseClickExample.js.map
