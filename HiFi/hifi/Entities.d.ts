...
declare var EntityItemID: {
    prototype: hifi.IEntityItemID;
    new (): hifi.IEntityItemID;
    new (other: hifi.IEntityItemID): hifi.IEntityItemID;

    /**
     * @param id QUuid
     * @param creatorTokenID uint32_t
     */
    new (id: number, creatorTokenID: number, isKnownID: boolean): hifi.IEntityItemID;

    /**
     * @param id QUuid
     */
    new (id: number): hifi.IEntityItemID;
     ...
     * @param creatorTokenID uint32_t
     */
    getIDfromCreatorTokenID(creatorTokenID: number): hifi.IEntityItemID;
     ...
     */
    readEntityItemIDFromBuffer(data: string, bytesLeftToRead: number): hifi.IEntityItemID;
}

declare var Entities: hifi.IEntityScriptingInterface;
